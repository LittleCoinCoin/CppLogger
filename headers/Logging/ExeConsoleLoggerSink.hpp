	...
	public:
		...
		*/
		LOGGING_API ExeConsoleLoggerSink() : LoggerSink()
		{
			...
			prefixFunctions[LogLevel_Trace] = static_cast<LoggerSink::prefix_pf>(&ExeConsoleLoggerSink::PrefixTrace);
			prefixFunctions[LogLevel_Debug] = static_cast<LoggerSink::prefix_pf>(&ExeConsoleLoggerSink::PrefixDebug);
			prefixFunctions[LogLevel_Error] = static_cast<LoggerSink::prefix_pf>(&ExeConsoleLoggerSink::PrefixError);
			prefixFunctions[LogLevel_Warning] = static_cast<LoggerSink::prefix_pf>(&ExeConsoleLoggerSink::PrefixWarning);
		}
